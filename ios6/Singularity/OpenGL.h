...
#include <TargetConditionals.h>
    ...
    #define GLFW_GL3
       ...
       #define glGenVertexArrays(_id, _addr)    glGenVertexArraysOES(_id, _addr)
       #define glBindVertexArray(_id)           glBindVertexArrayOES(_id)
       #define glDeleteVertexArrays(_id, _addr) glDeleteVertexArraysOES(_id, _addr)
    #else
       #include <OpenGL/gl.h>
